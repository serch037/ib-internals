...
\item 
\hlc[magenta]{
El BC y el jefe de censura prohíben el cine crítico-histórico.
}
...
\item 
\hlc[Mahogany]{
El discurso de los años cuarenta ignora la violencia de la Revolución y exalta su rol como forjador de paz
}
...
\item 
\hlc[green]{
Las películas de esta época instalan la ideología de la mexicanidad.
}
...
\subsection{Emilio ``El indio" Fernández}
    ...
    \item 
    \hlc[CadetBlue]{
    Su nacionalismo es polifacético y exaltado en sus películas
    }
    ...
    \item 
    \hlc[Cerulean]{
    Sus películas incorporan mensajes sociales
    }
...
%\subsubsection{Relación con la iglesia}
    ...
    \item 
    \hlc[Rhodamine]{
    El tema de la película (y \emph{Enamorada}) es la armonía entre las clases. Y refleja su contexto cultural más que la revolución misma
    }
    ...
    \item 
    \hlc[TealBlue]{
    ``[\ldots] [en el film] la lucha armada tuvo un buen principio [\ldots] [pero] provocaba desórdenes y víctimas inocentes''
    }
...
%\subsubsection{Relación con la iglesia}
    ...
    ``En \emph{Enamorada}, Iglesia y Revolución se reconcilian''
    ...
    \item \hlc[Dandelion]{
    ``[\ldots] esos son los verdaderos traidores, las sanguijuelas que se alimentan chupando la sangre de sus hermanos''
    }
    ...
    \item \hlc[Orchid]{
    Protagonista indaga sobre los ricos del pueblo y les exige sus bienes amenazándolos con fusilarlos
    }
